...
/* ------------------------------- 6. it renders, grades and completes */
{
    ...
    w.__api.startTopicExercises(11);
    const D = w.document;
    ...
    const gram = require('./_grammar_material.cjs').materialOf('A2', 11);
    const lesson = gram.text;
    ok(/Мне нравятся книги/.test(lesson), 'the grammar reaches the reader');
