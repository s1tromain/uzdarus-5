...
ok('grammar section rendered', !!lc.querySelector('.grammar-section .t1g'));
ok('grammar hero present', !!lc.querySelector('.t1g-hero-title'));
...
ok('grammar tables render as real tables', lc.querySelectorAll('.t1g-table').length >= 4);
...
ok('T2 grammar rendered', !!lc2.querySelector('.t1g-hero-title'));
...
ok('T2 grammar tables render', lc2.querySelectorAll('.t1g-table').length >= 8);
...
ok('T3 grammar rendered', !!lc3.querySelector('.t1g-hero-title'));
...
ok('T3 grammar tables render', lc3.querySelectorAll('.t1g-table').length >= 10);
...
ok('T4 grammar rendered', !!lc4.querySelector('.t1g-hero-title'));
...
ok('T4 grammar tables render', lc4.querySelectorAll('.t1g-table').length >= 12);
...
ok('T5 grammar rendered', !!lc5.querySelector('.t1g-hero-title'));
...
ok('T5 grammar tables render', lc5.querySelectorAll('.t1g-table').length >= 14);
